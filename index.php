                            ...
                            <div class="card border-0 shadow" style="max-width: 350px; margin:auto">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-evenly mb-2">
                                        ...
                                        <a href="room_details.php?id=$room_data[id]" class="btn btn-sm btn-outline-dark shadow-none">More detials</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="swiper swiper-testimonials">
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white p-4 ">
                    <div class="profile d-flex  align-items-cneter mb-3">
                        <img src="images/features/star.svg" width="30px">
                        <h6 class="m-0 ms-2">Ramdom user1</h6>
                    </div>
                    <p>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ab iste eius esse vitae error itaque
                        nostrum suscipit modi vero inventore.
                    </p>
                    <div class="rating">
                        <span class="badge rounded-pill bg-light">
                            <i class="bi bi-star-fill text-warning"></i>
