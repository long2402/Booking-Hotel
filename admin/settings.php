            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customers will be allowed to book hotel room, when shutdown mode is turned on (Only for
                            Website Maintenance).
                        </p>
                    </div>
                </div>
                                    ...
                                    <div class="container-fluid p-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label fw-bold">Phone Numbers (with country
                                                        code)</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="ins" id="insta_inp"
                                                            class="form-control shadow-none" required>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"> <i class="bi bi-twitter"></i>
                                                        </span>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="member_picture" id="member_picture_inp"
                                            accept="[.jpg, .png, .webg, .jpeg]" class="form-control shadow-none"
                                            required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" onclick="member_name.value='', member_picture.value=''" class="btn btn-secondary shadow-none"
